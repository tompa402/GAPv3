...
namespace GAPv3.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<GAPv3.DAL.GAPv3Context>
    {
        ...
        protected override void Seed(GAPv3.DAL.GAPv3Context context)
        {
            ...
            context.Norms.Add(new Norm()
            {
                ...
                Description = "Informacijska tehnologija - Sigurnosne tehnike - Sustavi upravljanja informacijskom sigurnošæu - Zahtjevi"
            });
            context.Norms.Add(new Norm()
            {
                NormId = 2,
            ...
            context.NormItems.Add(new NormItem() { NormItemId = 3, Name = "Razumijevanje potreba i oèekivanja zainteresiranih strana", IsItem = true, Order = 2, ParentId = 1, NormId = 1 });
            context.NormItems.Add(new NormItem() { NormItemId = 4, Name = "Definiranje opsega ISMS-a", IsItem = true, Order = 3, ParentId = 1, NormId = 1 });
            context.NormItems.Add(new NormItem() { NormItemId = 5, Name = "Sustav upravljanja informacijskom sigurnošæu", IsItem = true, Order = 4, ParentId = 1, NormId = 1 });
            ...
            context.NormItems.Add(new NormItem() { NormItemId = 12, Name = "Opæenito", IsItem = true, Order = 1, ParentId = 11, NormId = 1 });
            ...
            context.NormItems.Add(new NormItem() { NormItemId = 22, Name = "Opæenito", Order = 1, IsItem = true, ParentId = 21, NormId = 1 });
            ...
            context.NormItems.Add(new NormItem() { NormItemId = 30, Name = "Praæenje, mjerenje, analiza i procjena", IsItem = true, Order = 1, ParentId = 29, NormId = 1 });
            ...
            context.NormItems.Add(new NormItem() { Name = "Mobilni ureðaji i rad na daljinu", IsItem = false, ParentId = 40, Order = 2, NormId = 2 });
            context.NormItems.Add(new NormItem() { Name = "Mobilni ureðaji", IsItem = true, ParentId = 47, Order = 1, NormId = 2 });
            ...
            context.NormItems.Add(new NormItem() { Name = "Razina svijesti o informacijskoj sigurnosti, obrazovanje i obuèavanje", IsItem = true, ParentId = 54, Order = 2, NormId = 2 });
            ...
            context.NormItems.Add(new NormItem() { Name = "Oznaèavanje informacija", IsItem = true, ParentId = 66, Order = 2, NormId = 2 });
            ...
            context.NormItems.Add(new NormItem() { Name = "Prijevoz fizièkih medija", IsItem = true, ParentId = 70, Order = 3, NormId = 2 });
            ...
            context.NormItems.Add(new NormItem() { Name = "Granice fizièkog sigurnosnog prostora", IsItem = true, ParentId = 75, Order = 1, NormId = 2 });
            context.NormItems.Add(new NormItem() { Name = "Kontrole fizièkog pristupa", IsItem = true, ParentId = 75, Order = 2, NormId = 2 });
            context.NormItems.Add(new NormItem() { Name = "Upravljanje korisnièkim pristupom", IsItem = false, ParentId = 74, Order = 2, NormId = 2 });
            context.NormItems.Add(new NormItem() { Name = "Prijava i odjava korisnika", IsItem = true, ParentId = 78, Order = 1, NormId = 2 });
            context.NormItems.Add(new NormItem() { Name = "Dodjeljivanje korisnièkih prava", IsItem = true, ParentId = 78, Order = 2, NormId = 2 });
            ...
            context.NormItems.Add(new NormItem() { Name = "Provjera prava korisnièkog pristupa", IsItem = true, ParentId = 78, Order = 5, NormId = 2 });
            ...
            context.NormItems.Add(new NormItem() { Name = "Ogranièavanje pristupa informacijama", IsItem = true, ParentId = 87, Order = 1, NormId = 2 });
            context.NormItems.Add(new NormItem() { Name = "Procedura sigurnog prijavljivanja", IsItem = true, ParentId = 87, Order = 2, NormId = 2 });
            context.NormItems.Add(new NormItem() { Name = "Upravljanje korisnièkim zaporkama", IsItem = true, ParentId = 87, Order = 3, NormId = 2 });
            ...
            context.NormItems.Add(new NormItem() { Name = "Upravljanje kljuèevima", IsItem = true, ParentId = 94, Order = 2, NormId = 2 });
            context.NormItems.Add(new NormItem() { Name = "Fizièka sigurnost i sigurnost okruženja", IsItem = false, ParentId = null, Order = 11, NormId = 2 });
            context.NormItems.Add(new NormItem() { Name = "Granice fizièke sigurnosti", IsItem = false, ParentId = 97, Order = 1, NormId = 2 });
            context.NormItems.Add(new NormItem() { Name = "Politika kontrole pristupa", IsItem = true, ParentId = 98, Order = 1, NormId = 2 });
            context.NormItems.Add(new NormItem() { Name = "Kontrole fizièkog pristupa", IsItem = true, ParentId = 98, Order = 2, NormId = 2 });
            ...
            context.NormItems.Add(new NormItem() { Name = "Rad u osiguranim podruèjima", IsItem = true, ParentId = 98, Order = 5, NormId = 2 });
            context.NormItems.Add(new NormItem() { Name = "Podruèja sa javnim pristupom, podruèja za istovar i utovar", IsItem = true, ParentId = 98, Order = 6, NormId = 2 });
            ...
            context.NormItems.Add(new NormItem() { Name = "Sigurnost ožièenja", IsItem = true, ParentId = 105, Order = 3, NormId = 2 });
            ...
            context.NormItems.Add(new NormItem() { Name = "Korisnièka oprema bez nadzora", IsItem = true, ParentId = 105, Order = 8, NormId = 2 });
            ...
            context.NormItems.Add(new NormItem() { Name = "Zaštita od zloæudnog koda", IsItem = false, ParentId = 115, Order = 2, NormId = 2 });
            context.NormItems.Add(new NormItem() { Name = "Kontrole za zaštitu od zloæudnog koda", IsItem = true, ParentId = 121, Order = 1, NormId = 2 });
            ...
            context.NormItems.Add(new NormItem() { Name = "Zapisi o dogaðajima", IsItem = true, ParentId = 125, Order = 1, NormId = 2 });
            ...
            context.NormItems.Add(new NormItem() { Name = "Upravljanje tehnièkom ranjivošæu", IsItem = false, ParentId = 115, Order = 6, NormId = 2 });
            context.NormItems.Add(new NormItem() { Name = "Upravljanje tehnièkom ranjivošæu", IsItem = true, ParentId = 132, Order = 1, NormId = 2 });
            context.NormItems.Add(new NormItem() { Name = "Ogranièenja za instalaciju softvera", IsItem = true, ParentId = 132, Order = 2, NormId = 2 });
            ...
            context.NormItems.Add(new NormItem() { Name = "Upravljanje sigurnošæu mreže", IsItem = false, ParentId = 137, Order = 1, NormId = 2 });
            ...
            context.NormItems.Add(new NormItem() { Name = "Tehnièka provjera aplikacija nakon promjena operativne platforme", IsItem = true, ParentId = 152, Order = 3, NormId = 2 });
            context.NormItems.Add(new NormItem() { Name = "Ogranièenje promjena softverskih paketa", IsItem = true, ParentId = 152, Order = 4, NormId = 2 });
            ...
            context.NormItems.Add(new NormItem() { Name = "Testiranje prihvaæanja sustava", IsItem = true, ParentId = 152, Order = 9, NormId = 2 });
            ...
            context.NormItems.Add(new NormItem() { Name = "Odnosi s dobavljaèima", IsItem = false, ParentId = null, Order = 15, NormId = 2 });
            context.NormItems.Add(new NormItem() { Name = "Informacijska sigurnost u odnosu s dobavljaèima", IsItem = false, ParentId = 164, Order = 1, NormId = 2 });
            context.NormItems.Add(new NormItem() { Name = "Politika sigurnosti za odnose s dobavljaèima", IsItem = true, ParentId = 165, Order = 1, NormId = 2 });
            context.NormItems.Add(new NormItem() { Name = "Ukljuèivanje sigurnosti u ugovore s dobavljaèima", IsItem = true, ParentId = 165, Order = 2, NormId = 2 });
            ...
            context.NormItems.Add(new NormItem() { Name = "Upravljanje isporukama dobavljaèa", IsItem = false, ParentId = 165, Order = 2, NormId = 2 });
            context.NormItems.Add(new NormItem() { Name = "Nadzor i provjera usluga dobavljaèa", IsItem = true, ParentId = 168, Order = 1, NormId = 2 });
            context.NormItems.Add(new NormItem() { Name = "Upravljanje promjenama usluga dobavljaèa", IsItem = true, ParentId = 168, Order = 2, NormId = 2 });
            ...
            context.NormItems.Add(new NormItem() { Name = "Upravljanje incidentima i unapreðenjima informacijske sigurnosti", IsItem = false, ParentId = 172, Order = 1, NormId = 2 });
            context.NormItems.Add(new NormItem() { Name = "Odgovornosti i procedure", IsItem = true, ParentId = 173, Order = 1, NormId = 2 });
            context.NormItems.Add(new NormItem() { Name = "Izvješæivanje o sigurnosnim dogaðajima", IsItem = true, ParentId = 173, Order = 2, NormId = 2 });
            context.NormItems.Add(new NormItem() { Name = "Izvješæivanje o sigurnosnim slabostima", IsItem = true, ParentId = 173, Order = 3, NormId = 2 });
            context.NormItems.Add(new NormItem() { Name = "Procjena i odluèivanje vezano za dogaðaje informacijske sigurnosti", IsItem = true, ParentId = 173, Order = 4, NormId = 2 });
            ...
            context.NormItems.Add(new NormItem() { Name = "Uèenje na sigurnosnim incidentima", IsItem = true, ParentId = 173, Order = 6, NormId = 2 });
            ...
            context.NormItems.Add(new NormItem() { Name = "Odreðivanje primjenjivih zakona", IsItem = true, ParentId = 189, Order = 1, NormId = 2 });
            ...
            context.NormItems.Add(new NormItem() { Name = "Usklaðenost sa sigurnosnim pravilima i standardima", IsItem = true, ParentId = 195, Order = 2, NormId = 2 });
            context.NormItems.Add(new NormItem() { Name = "Provjera tehnièke sukladnosti", IsItem = true, ParentId = 195, Order = 3, NormId = 2 });
